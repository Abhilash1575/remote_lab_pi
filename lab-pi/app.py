...
def factory_reset():
    ...
    python_exec = sys.executable
    commands = {
        'esp32': f"{python_exec} -m esptool --chip esp32 --port {port} --baud 115200 --before default-reset write-flash 0x10000 {fpath}",
        'esp8266': f"{python_exec} -m esptool --chip esp8266 --port {port} --baud 115200 --before default-reset write-flash 0x00000 {fpath}",
